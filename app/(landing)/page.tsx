        ...
        <section className="relative min-h-screen bg-[#0D0B08] text-[#F5F0E8] flex items-center overflow-hidden font-sans">
            ...
            <div className="relative z-10 w-full max-w-300 mx-auto px-6 py-4 md:py-0 grid md:grid-cols-2 gap-16 items-center">
                ...
                <div>
                    ...
                    {/* CTA */}
                    <div className="mb-12">
                        <Link href="/auth/login" className="inline-flex items-center gap-2.5 bg-[#3b68d8] text-white text-[0.95rem] font-semibold px-7 py-3.5 rounded-full transition-all duration-200 hover:bg-[#3b68d8] hover:-translate-y-px hover:shadow-[0_8px_24px_rgba(59,104,216,0.4)] group"
                        >Get started</Link>
                    </div>
