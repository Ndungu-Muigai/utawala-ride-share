...
import { Search, MoreVertical, Star, Car, TrendingUp, AlertTriangle, AlertCircle, X, CheckCircle } from "lucide-react"
                ...
                <p className={`text-xs mt-0.5 ${isSuspended ? "text-red-500" : "text-emerald-500"}`}>
                    {
                        isSuspended
                        ? 
                            `${toast.driverName} has been suspended.`
                        : 
                            `${toast.driverName}'s account has been reinstated.`
                    }
                </p>
            </div>
            ...
            {open && createPortal(
                <>
                    ...
                    <div
                        ...
                        className="fixed z-20 bg-white border border-gray-200 rounded-lg shadow-lg min-w-40 overflow-hidden"
                    >
                        {actions.map((a) => (
...
const DriversPage = () =>
{
    ...
    const handleSetActive = (id: string) =>
    {
        ...
        {
            setToasts((prev) => [
                {id: Date.now(), driverName: driver.name, status: "active",},...prev,
            ])
        }
    }
    ...
    return (
        <div className="px-4 pb-6">
            ...
            <div className="bg-white border border-gray-300 rounded-xl overflow-visible">
                ...
                {/* Footer */}
                <div className="p-5 border-t border-gray-100 text-xs text-gray-400">
